<?php
    ...
    if(isset($_SESSION['user_login'])){  
        ...
        $idAsignatura = filter_input(INPUT_GET, 'idasignatura', FILTER_VALIDATE_INT) ?? filter_input(INPUT_POST, 'idasignatura', FILTER_VALIDATE_INT);
    ...
    <body>
        ...
        <main class="main">
            <?php
                ...
                $Usuariost = $pdo->prepare("SELECT *FROM asignatura;");
                $Usuariost->execute();
