                ...
                <div>
                    <div class="card">
                        <table class="permissions-table">
                            ...
                            <?php
                                $Usuariost = $pdo->prepare("SELECT B.nombre, B.name, B.apellido, A.email AS EM, A.role, B.estado, B.ciudad, B.calle1, B.calle2, B.cp, B.pais FROM users A INNER JOIN perfil B ON A.ID = B.iduser;");
                                $Usuariost->execute();
