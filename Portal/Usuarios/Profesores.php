<?php
    ...
    if(isset($_SESSION['user_login'])){    
        ...
        if($_SERVER['REQUEST_METHOD'] === 'POST'){
            ...
            header("Location: Profesor.php?ok=1");
        }
?>
    <!DOCTYPE html>
    <html lang="es">
                            ...
                            <div class="dropDown" id="submenu-usuarios">
                                <div class="scroll tab-content active" id="tab-teaching">
                                    <ul>
                                        ...
                                        <a href="#" style="color:#000;">👨‍🏫 Profesores</a>
                ...
                <div>
                    <div class="card">
                        <table class="permissions-table">
                            ...
                            <?php
                                $Usuariost = $pdo->prepare("SELECT B.nombre, B.name, B.apellido, A.email AS EM, A.role, B.estado, B.ciudad, B.calle1, B.calle2, B.cp, B.pais FROM users A INNER JOIN perfil B ON A.ID = B.iduser WHERE A.role='profesor';");
                                $Usuariost->execute();
