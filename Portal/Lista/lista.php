...
<html lang="en">
    ...
    <body>
        <header class="topbar">
            ...
            <div class="top-icons">  
                <a href="../Carrera/actividades.php">
                    💬
                </a>
                ...
                <a href="../calendario.php" class="top-icon">
                    ...
                    <div class="dropDown" id="submenu-classes">
                        ...
                        <div class="scroll tab-content active" id="tab-teaching">
                            <?php
                                ...
                                $idCuatrimestre = $rowArea['idcuatrimestre']??null;

                                $asignatura = $pdo->prepare("SELECT  *FROM asignatura A
                                                            INNER JOIN carrera B ON A.idcarrera = B.id
                                                            INNER JOIN cuatrimestre C ON A.idcuatrimestre = C.idcuatrimestre
                                                            WHERE C.idcuatrimestre = :cuatri AND A.idcarrera = :carrera");
                                $asignatura->execute([
                                    ':cuatri' => $idCuatrimestre,
                                    ':carrera' => $idCarrera
                                ]);
                            ?>
                            <?php if($row['role'] == 'admin'): ?>
                    ...
                    <select name="idasignatura" required>
                        ...
                        <?php
                            $asignaturasAll = $pdo->prepare("SELECT * FROM asignatura 
                                WHERE idcarrera = :carrera AND idcuatrimestre = :cuatri");
                            $asignaturasAll->execute([
                                ':carrera' => $idCarrera,
                                ':cuatri' => $idCuatrimestre
                            ]);
